...
#define MACRLC_SRS_PRG_SIZE                  "srs_prg_size"
...
#define HLP_MACRLC_SRS_PRG_SIZE "PRG size in RBs of the SRS channel estimate reported by L1 (SRS PDU prgSize). Value range [1, 272]"
...
#define MACRLCPARAMS_DESC { \
  ...
  {MACRLC_SRS_PRG_SIZE,                HLP_MACRLC_SRS_PRG_SIZE,  0, .u16ptr=NULL, .defintval=1,               TYPE_UINT16,  0}, \
}
// clang-format off
...
#define MACRLCPARAMS_CHECK { \
  ...
  { .s2 = { config_check_intrange, {1, 272} } }, /* SRS PRG size */ \
}
